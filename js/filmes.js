...
function fecharModal() {
  ...
  function closeTargetModal() {
    ...
    const elemPai = parentTarget.closest('[class*="modal_filmes_container_"]');
...
function addFilme(e) {
  ...
  const obj = {
    ...
    trailer: convertLinkYoutube(document.querySelector("#filme_trailer").value),
...
function fillInput() {
  let x = filmesList.find(
    (e) => e.titulo == document.querySelector("#edit_selecionar_filme").value,
  );
...
function deletFilme(e) {
  ...
  const obj = {
    id: filmesList.find(
      (e) => e.titulo == document.querySelector("#del_selecionar_filme").value,
    ).id,
  };
